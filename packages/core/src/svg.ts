...
export function renderDeterministicSvg(scene: SvgScene): string {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${VIDEO_PROFILE.width}" height="${VIDEO_PROFILE.height}" viewBox="0 0 ${VIDEO_PROFILE.width} ${VIDEO_PROFILE.height}" role="img" aria-labelledby="scene-title"><title id="scene-title">${escapeXml(scene.title)}</title><defs><linearGradient id="background" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#08111f"/><stop offset="1" stop-color="#111d35"/></linearGradient><filter id="shadow"><feDropShadow dx="0" dy="12" stdDeviation="18" flood-color="#000000" flood-opacity="0.28"/></filter></defs><style>.eyebrow{font:700 25px Inter,Segoe UI,sans-serif;letter-spacing:5px;fill:${accent}}.title{font:760 68px Inter,Segoe UI,sans-serif;fill:#f6f8ff}.body-text{font:500 36px Inter,Segoe UI,sans-serif;fill:#c9d4e8}.node{fill:#152641;stroke:${accent};stroke-width:3;filter:url(#shadow)}.node-text{font:650 30px Inter,Segoe UI,sans-serif;fill:#eef4ff}.code-panel{fill:#08101d;stroke:#293d5d;stroke-width:2;filter:url(#shadow)}.code-text{font:500 22px Consolas,Cascadia Mono,monospace;fill:#d5e2f5}.caption{font:650 ${CAPTION_STYLE.fontSizePx}px Inter,Segoe UI,sans-serif;fill:#ffffff;paint-order:stroke;stroke:#07101d;stroke-width:8px;stroke-linejoin:round}</style><rect width="1920" height="1080" fill="url(#background)"/><path d="M0 0H720L420 1080H0Z" fill="#0d1a2d" opacity=".72"/><text x="96" y="108" class="eyebrow">${escapeXml(eyebrow)}</text>${title}${body}${code}<rect id="caption-reserved-band" x="${CAPTION_BAND.x}" y="${CAPTION_BAND.y}" width="${CAPTION_BAND.width}" height="${CAPTION_BAND.height}" rx="24" fill="#07101d" opacity="${captionLines.length > 0 ? ".88" : ".18"}"/>${captions}<text x="1824" y="1040" text-anchor="end" font-family="Inter,Segoe UI,sans-serif" font-size="20" fill="#71809d">UNDERSTAND VIDEO · ${escapeXml(scene.id)}</text></svg>`;
}
