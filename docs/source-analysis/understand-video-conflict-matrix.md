...
| TEMPO is Python while Understand-Anything is TypeScript | Keep TEMPO as the repository governance kernel and add product code as a TypeScript workspace only after authorization. Avoid porting or weakening TEMPO gates. |
